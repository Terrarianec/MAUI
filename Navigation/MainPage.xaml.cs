...
public partial class MainPage : ContentPage
{
	...
	public MainPage(AccessManager accessManager, IServiceProvider services)
	{
		InitializeComponent();
	...
	private async void OnCompressButtonClicked(object sender, EventArgs e)
	{
		...
		var active = elements.First();

		if (active == card && !_accessManager.HasAccess)
		{
			await Navigation.PushModalAsync(_services.GetService<GuardModalPage>());
